...
using UnityEngine;
    ...
    namespace TheFates
    {
        ...
        public class FatesKeeper : MonoBehaviour
        {
            ...
            private string savePath = "Assets/TheFates/QuestSystem/QuestLines";
            ...
            public void WeaveLogicFromSelection()
            {
                ...
                string folderPath = Path.Combine(Application.dataPath, "TheFates", "QuestLines");
                if (!Directory.Exists(folderPath))
                {
                    Directory.CreateDirectory(folderPath);
                }
                string fullPath = Path.Combine(Application.dataPath.Replace("Assets", ""), folderPath);
                string scriptFileName = "ThreadsOf" + questLineToWeave.questLineName.Replace("_","") + ".cs"; 
                ...
                NonaTheSpinner.Instance.WeaveFullQuestLine(questLineToWeave);
